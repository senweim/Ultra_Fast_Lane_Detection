...
def generate_segmentation_and_train_list(root, line_txt, names, phase='train'):
    """
    ...
    train_gt_fp = open(os.path.join(root, phase + '_gt.txt'), 'w')
...
if __name__ == "__main__":
    ...
    # training set
    names,line_txt = get_tusimple_list(args.root,  ['label_data_0531.json','label_data_0313.json'])
    # generate segmentation and training list for training
    generate_segmentation_and_train_list(args.root, line_txt, names, 'train')
    
    # val set
    names,line_txt = get_tusimple_list(args.root,  ['label_data_0601.json'])
    # generate segmentation and training list for val
    generate_segmentation_and_train_list(args.root, line_txt, names, 'val')
